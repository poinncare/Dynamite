...
class DynamiteSkyLightWindow: NSPanel {
    private var isSkyLightEnabled: Bool = false
    /// When true, panel can become key so clipboard tab receives keyDown (WASD/arrows).
    private var allowKeyFocus: Bool = false
