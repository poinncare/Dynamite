//
//  UsagePaths.swift
//  Dynamite — real-user paths for auth files (sandbox-safe)
//
...
enum UsagePaths {
    ...
    static var pocketClaudeCredentialsFile: String {
        underHome("Library", "Application Support", "Dynamite", "UsageAuth", "claude.credentials.json")
    }
    ...
    static var containerUsageAuthDir: String {
        ...
        return base.appendingPathComponent("Dynamite/UsageAuth", isDirectory: true).path
    }
    ...
    static func ensureUsageAuthDirectories() {
        ...
        let homeDir = underHome("Library", "Application Support", "Dynamite", "UsageAuth")
    ...
    static var pocketCodexAuthFile: String {
        underHome("Library", "Application Support", "Dynamite", "UsageAuth", "codex.auth.json")
    }
    ...
    static var pocketGrokAuthFile: String {
        underHome("Library", "Application Support", "Dynamite", "UsageAuth", "grok.auth.json")
    }
