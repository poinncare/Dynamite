...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "com.poinncare.dynamite.DynamiteXPCHelper"
    
    private var remoteService: RemoteXPCService<DynamiteXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<DynamiteXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<DynamiteXPCHelperProtocol>(
            connection: conn,
            remoteInterface: DynamiteXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<DynamiteXPCHelperProtocol>? {
        remoteService
    }
