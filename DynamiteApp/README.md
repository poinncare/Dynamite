<h1 align="center">
  <br>
  <a href="http://theboring.name"><img src="https://framerusercontent.com/images/RFK4vs0kn8pRMuOO58JeyoemXA.png?scale-down-to=256" alt="Dynamite" width="150"></a>
  <br>
  Dynamite
  <br>
</h1>
...
<p align="center">
  <a title="Crowdin" target="_blank" href="https://crowdin.com/project/dynamite"><img src="https://badges.crowdin.net/dynamite/localized.svg"></a>
  <img src="https://github.com/poinncare/Dynamite/actions/workflows/cicd.yml/badge.svg" alt="Dynamite Build & Test" style="margin-right: 10px;" />
...
<!-- Welcome to Dynamite, the coolest way to make your MacBook's notch the star of the show! -->

Say hello to **Dynamite**, the coolest way to make your MacBook’s notch the star of the show! Say goodbye to boring status bars: with Dynamite, your notch transforms into a dynamic music control center, complete with a vibrant visualizer and all the essential music controls you need. But that’s just the start! Dynamite also offers calendar integration, a handy file shelf with AirDrop support, a complete MacOS HUD replacement and more!
...
<a href="https://github.com/poinncare/Dynamite/releases/latest/download/Dynamite.dmg" target="_self"><img width="200" src="https://github.com/user-attachments/assets/e3179be1-8416-4b8a-b417-743e1ecc67d6" alt="Download for macOS" /></a>

Once downloaded, open the `.dmg` and move **Dynamite** to your `/Applications` folder.

> [!IMPORTANT]
> We don't have an Apple Developer account (yet 👀), so macOS will warn you that Dynamite is from an unidentified developer on first launch. This is expected behavior.
>
...
After moving Dynamite to your Applications folder, run:
...
4. Scroll to the bottom and click **Open Anyway** next to the Dynamite warning.
...
<a href="https://www.star-history.com/#poinncare/Dynamite&Timeline">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=poinncare/Dynamite&type=Timeline&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=poinncare/Dynamite&type=Timeline" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=poinncare/Dynamite&type=Timeline" />
 </picture>
</a>
...
- **[NotchDrop](https://github.com/Lakr233/NotchDrop)** – An open-source project that has been instrumental in developing the first version of the "Shelf" feature in Dynamite.
...
- **You**: For being awesome and checking out **Dynamite**!
