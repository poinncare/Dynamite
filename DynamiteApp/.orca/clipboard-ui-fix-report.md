...
## Changed files
- `Dynamite/components/ClipboardHistory/Views/ClipboardHistoryView.swift` — full rewrite of layout
- `Dynamite/components/ClipboardHistory/Views/ClipboardCardView.swift` — adaptive size + inset selection + preview
...
** BUILD SUCCEEDED **
```
(command: `DEVELOPER_DIR=... xcodebuild -project Dynamite.xcodeproj -scheme Dynamite -configuration Debug -destination platform=macOS -derivedDataPath /tmp/Dynamite-ui2 build`)
